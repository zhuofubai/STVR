...
%\begin{figure*}[!thpb]
%\centering
%\includegraphics[width=0.8\textwidth]{NUMFL-GPS-Algorithm.eps}
...
\bibitem{Wolfgang2008} Mayer, Wolfgang, and Markus Stumptner. "Evaluating models for model-based debugging." Proceedings of the 2008 23rd IEEE/ACM International Conference on Automated Software Engineering. IEEE Computer Society, 2008.

 \bibitem{Wolfgang2009}Mayer, Wolfgang, et al. "Prioritising model-based debugging diagnostic reports." Proceedings of the International Workshop on Principles of Diagnosis (DX). 2009.
